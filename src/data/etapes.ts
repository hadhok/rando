...
export const ETAPES_BIDARRAY_SARE: Etape[] = [
  {
    ...
    itineraire:
      'Bidarray bourg → montée vers le Pas de Roland → arête d\'Iparla (1044 m, exposition au vent) → Col Harrieta (687 m) → Col Méhatsé (708 m) → descente par les pâturages → Ainhoa.',
    ravitaillement:
  ...
  },
  {
    ...
    itineraire:
      'Ainhoa → Col Meharroste → crête de Larraun → Col Lizuniaga (441 m) → descente par le chemin des karsts → Sare.',
    ravitaillement:
