...
export const ETAPES_BIDARRAY_SARE: Etape[] = [
  {
    ...
    difficulte: 'moyen',
    description:
      'Départ du charmant village de Bidarray au bord de la Nive. Longue montée vers les crêtes d\'Iparla (1044 m), l\'un des plus beaux belvédères du Pays Basque avec ses panoramas à 360°. Descente progressive sur Ainhoa, l\'un des plus beaux villages de France.',
    itineraire:
      'Bidarray → Pas de Roland → arête d\'Iparla (1044 m, exposition au vent) → Col Harrieta (687 m) → Col Méhatsé (708 m) → descente pâturages → Ainhoa.',
    ravitaillement:
      'Bidarray : bar-épicerie Noblia (fermé lundi). Aucun commerce sur l\'arête. Ainhoa : boulangerie, épicerie, restaurants, piment d\'Espelette.',
    eau:
      'Nive à Bidarray. Source au Col Harrieta. Pas d\'eau sur l\'arête d\'Iparla (prévoir 2 L). Fontaine à Ainhoa.',
    hebergement:
      'Ainhoa : gîte communal (réservation mairie), Hôtel Ithurria, chambres d\'hôtes. Camping Harazpy.',
    retourHendaye:
      'Bus ATCRB C5 : Ainhoa → Saint-Jean-de-Luz → Hendaye (1h15, GRATUIT). Taxi direct Ainhoa → Hendaye : ~55€.',
    coordDepart: { lat: 43.2753, lng: -1.3786 },
    coordArrivee: { lat: 43.3069, lng: -1.4972 },
  },
  {
    ...
    difficulte: 'facile',
    description:
      'Étape finale à travers les collines verdoyantes du Labourd. Chemins creux, hêtraies et cols frontières discrets. Arrivée à Sare dominée par la Rhune, classé parmi les plus beaux villages de France.',
    itineraire:
      'Ainhoa → Col Meharroste → crête de Larraun → Col Lizuniaga (441 m) → chemin des karsts → Sare.',
    ravitaillement:
      'Sare : boulangerie, épicerie, restaurants basques, marché le vendredi. Fromage de brebis en vente directe sur le chemin.',
    eau:
      'Source au col Meharroste. Ruisseau avant Sare. Plusieurs fontaines dans le village.',
    hebergement:
      'Sare : gîte d\'étape municipal (50 places), Hôtel Arraya, Camping Goyetchea. Nombreuses chambres d\'hôtes.',
    retourHendaye:
      'Bus ATCRB C6 : Sare → Saint-Jean-de-Luz → Hendaye (45 min, GRATUIT). Taxi direct Sare → Hendaye : ~35€.',
    coordDepart: { lat: 43.3069, lng: -1.4972 },
    coordArrivee: { lat: 43.3119, lng: -1.5847 },
  },
];
