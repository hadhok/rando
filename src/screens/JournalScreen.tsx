...
const s = StyleSheet.create({
  ...
  resetBtnText: { fontFamily: FF.mono, fontSize: 9, color: C.inkMuted },
  ...
  progressCount: { fontFamily: FF.mono, fontSize: 9, color: C.inkMuted },
  nextStageRow: { marginTop: 10, paddingTop: 10, borderTopWidth: 1, borderTopColor: C.line2 },
  nextStageLabel: { fontFamily: FF.mono, fontSize: 10, letterSpacing: 1, textTransform: 'uppercase', color: C.inkMuted, marginBottom: 2 },
  nextStageName: { fontFamily: FF.display, fontSize: 13, fontWeight: '600', color: C.ink, letterSpacing: -0.3 },
  nextStageMeta: { fontFamily: FF.mono, fontSize: 10, color: C.inkMuted, marginTop: 2 },
  ...
  dayCount: { fontFamily: FF.mono, fontSize: 9, color: C.inkMuted },
  ...
  stageMeta: { fontFamily: FF.mono, fontSize: 9, color: C.inkMuted, marginTop: 2 },
  ...
  formLabel: { fontFamily: FF.mono, fontSize: 9, letterSpacing: 1, textTransform: 'uppercase', color: C.inkMuted, width: 52 },
  ...
  cancelBtnText: { fontFamily: FF.mono, fontSize: 10, color: C.inkMuted },
  ...
  emptyJournalText: { fontFamily: FF.mono, fontSize: 10, color: C.inkMuted, textAlign: 'center', lineHeight: 16 },
  ...
  entryDate: { fontFamily: FF.mono, fontSize: 10, color: C.inkMuted },
  entryEmojis: { flexDirection: 'row', gap: 4 },
  entryEmoji: { fontSize: 16 },
  entryPreview: { fontFamily: FF.mono, fontSize: 11, color: C.inkMuted, lineHeight: 16 },
  ...
  emptyText: { fontFamily: FF.mono, fontSize: 11, color: C.inkMuted, textAlign: 'center', lineHeight: 16, maxWidth: 260 },
});
